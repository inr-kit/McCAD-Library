...
namespace McCAD::Conversion{
    ...
    public:
        MCNPExprGenerator();
        MCNPExprGenerator(const double& precision, const double& scalingFactor,const double& angularTolerance);
        ~MCNPExprGenerator();

    private:
        double precision{1.0e-6}, scalingFactor{1.0}, angularTolerance{1.0e-4};
    public:
