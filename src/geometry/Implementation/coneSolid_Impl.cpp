...
void
McCAD::Geometry::CONESolid::Impl::judgeDecomposeSurfaces(Solid::Impl*& solidImpl,
...
void
McCAD::Geometry::CONESolid::Impl::judgeAssistDecomposeSurfaces(Solid::Impl* solidImpl,
    Standard_Real precision,
    Standard_Real distanceTolerance) {
    // Judge whether boundary surfaces of the solid can be used for decomposition.
...
void
McCAD::Geometry::CONESolid::Impl::judgeThroughConcaveEdges(Solid::Impl*& solidImpl) {
