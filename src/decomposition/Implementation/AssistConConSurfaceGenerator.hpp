#ifndef ASSISTCONCONSURFACEGENERATOR_HPP
#define ASSISTCONCONSURFACEGENERATOR_HPP
...
namespace McCAD::Decomposition{
  class AssistConConSurfaceGenerator{
  public:
      AssistConConSurfaceGenerator(const IO::InputConfig& inputConfig);
      ~AssistConConSurfaceGenerator();
  private:
...
#endif //ASSISTCONCONSURFACEGERAOR_HPP
