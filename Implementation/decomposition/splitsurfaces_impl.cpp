...
Standard_Boolean
McCAD::Decomposition::SplitSurfaces::Impl::throughNoBoundarySurfaces(std::vector<std::shared_ptr<Geometry::BoundSurface>>& facesList){
  if (facesList.empty())
    {
...
Standard_Boolean
McCAD::Decomposition::SplitSurfaces::Impl::planeSplitOnlyPlane(std::vector<std::shared_ptr<Geometry::BoundSurface>>& facesList){
  if (facesList.empty())
    {
      return Standard_False;
    }
...
void
McCAD::Decomposition::SplitSurfaces::Impl::generateSplitFacesList(std::vector<std::shared_ptr<Geometry::BoundSurface>>& splitFacesList,
